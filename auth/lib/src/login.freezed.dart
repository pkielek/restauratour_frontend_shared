...
abstract class $LoginDataCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String email, String password, bool showPassword, String errorMessage});
}
...
class _$LoginDataImpl extends _LoginData {
  ...
  @override
  String toString() {
    return 'LoginData(email: $email, password: $password, showPassword: $showPassword, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, showPassword, errorMessage);
...
abstract class _LoginData extends LoginData {
  factory _LoginData(
      ...
      final String password,
      final bool showPassword,
      final String errorMessage}) = _$LoginDataImpl;
